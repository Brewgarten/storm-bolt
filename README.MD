# storm-bolt
This project contains the module for cluster provisioning for the **Storm** project.

Storm-bolt cloud tooling for developers. It is an extension of the Apache libcloud framework.
